...
class StatsController extends GetxController {
  ...
  Future<void> loadTodayStats() async {
    ...
    todaySessions.value = await _db.getSessionsByDateRange(startOfDay, endOfDay);
  }
  ...
  int get currentPomodoros {
    return selectedPeriod.value == 'today' ? todayPomodoros.value : weekPomodoros.value;
  }

  int get totalMinutes {
    final sessions = currentSessions.where((s) => s.completed && s.type == 'work');
  ...
  double get completionRate {
    ...
    final completed = currentSessions.where((s) => s.completed && s.type == 'work').length;
  ...
  List<PomodoroSession> get workSessions {
    return currentSessions.where((s) => s.type == 'work' && s.completed).toList();
  }
}
